...
SC_MODULE(testbench) {
  ...
  long long unsigned int duration_1;
  ...
  testbench(sc_module_name name, int impl_jump_start_instr)
  : sc_module(name),
     master("master", "axi_commands_for_2_lstm_64x64.txt", impl_jump_start_instr), //"axi_commands_for_kmeans_clustering_for_LSTM_4_timesteps_zero_first_enabled_4PEs.csv"),
     ...
     #ifdef RUN_ILATOR
     ,flex_i("flexnlp"),
     impl_jump_start_instr(impl_jump_start_instr)
     #endif 
     {
    dut.clk(clk);
    dut.rst(rst);
    ...
    duration = std::chrono::duration_cast<std::chrono::nanoseconds>(t1 - ref).count();       
    std::string filename = "axi_commands_for_2_lstm_64x64.txt";
    jump_start_ilator(filename);
    swap();
  ...
  void jump_start_ilator(std::string& filename) {
    ...
    for (int i = 0; i < impl_jump_start_instr; i++) {
      ...
      ss_data << hex << vec[3];
      ss_data >> data; 
      flex_i.flex_if_axi_wr = wr;
      flex_i.flex_if_axi_rd = !wr;
      flex_i.flex_addr_in = addr;
      flex_i.flex_data_in_0 = (data) & 0xff;
      flex_i.flex_data_in_1 = (data >> 8) & 0xff;
      flex_i.flex_data_in_2 = (data >> 16) & 0xff;
      flex_i.flex_data_in_3 = (data >> 24) & 0xff;
      flex_i.flex_data_in_4 = (data >> 32) & 0xff;
      flex_i.flex_data_in_5 = (data >> 40) & 0xff;
      flex_i.flex_data_in_6 = (data >> 48) & 0xff;
      flex_i.flex_data_in_7 = (data >> 56) & 0xff;
      flex_i.flex_data_in_8 = (data >> 64) & 0xff;
      flex_i.flex_data_in_9 = (data >> 72) & 0xff;
      flex_i.flex_data_in_11 = (data >> 80) & 0xff;
      flex_i.flex_data_in_10 = (data >> 88) & 0xff;
      flex_i.flex_data_in_12 = (data >> 96) & 0xff;
      flex_i.flex_data_in_13 = (data >> 104) & 0xff;
      flex_i.flex_data_in_14 = (data >> 112) & 0xff;
      flex_i.flex_data_in_15 = (data >> 120) & 0xff;   
      flex_i.compute();
    } 
  }

  void swap() {
    dut.gb_inst.gbmodule_inst.gbcore_inst.num_vector_large[0] = to_ac(flex_i.flex_gb_core_mem_mngr_large_num_vector_0);
    dut.gb_inst.gbmodule_inst.gbcore_inst.num_vector_large[1] = to_ac(flex_i.flex_gb_core_mem_mngr_large_num_vector_1);
    dut.gb_inst.gbmodule_inst.gbcore_inst.num_vector_large[2] = to_ac(flex_i.flex_gb_core_mem_mngr_large_num_vector_2);
    dut.gb_inst.gbmodule_inst.gbcore_inst.num_vector_large[3] = to_ac(flex_i.flex_gb_core_mem_mngr_large_num_vector_3);
    dut.gb_inst.gbmodule_inst.gbcore_inst.base_large[0] = to_ac(flex_i.flex_gb_core_mem_mngr_large_base_large_0);
    dut.gb_inst.gbmodule_inst.gbcore_inst.base_large[1] = to_ac(flex_i.flex_gb_core_mem_mngr_large_base_large_1);
    dut.gb_inst.gbmodule_inst.gbcore_inst.base_large[2] = to_ac(flex_i.flex_gb_core_mem_mngr_large_base_large_2);
    dut.gb_inst.gbmodule_inst.gbcore_inst.base_large[3] = to_ac(flex_i.flex_gb_core_mem_mngr_large_base_large_3);
    dut.gb_inst.gbmodule_inst.gbcontrol_inst.gbcontrol_config.is_valid = to_ac(flex_i.flex_gb_control_is_valid);
    dut.gb_inst.gbmodule_inst.gbcontrol_inst.gbcontrol_config.mode = to_ac(flex_i.flex_gb_control_mode);
    dut.gb_inst.gbmodule_inst.gbcontrol_inst.gbcontrol_config.is_rnn = to_ac(flex_i.flex_gb_control_is_rnn);
    dut.gb_inst.gbmodule_inst.gbcontrol_inst.gbcontrol_config.memory_index_1 = to_ac(flex_i.flex_gb_control_memory_index_1);
    dut.gb_inst.gbmodule_inst.gbcontrol_inst.gbcontrol_config.memory_index_2 = to_ac(flex_i.flex_gb_control_memory_index_2);
    dut.gb_inst.gbmodule_inst.gbcontrol_inst.gbcontrol_config.num_vector_1 = to_ac(flex_i.flex_gb_control_num_vector_1);
    dut.gb_inst.gbmodule_inst.gbcontrol_inst.gbcontrol_config.num_vector_2 = to_ac(flex_i.flex_gb_control_num_vector_2);
    dut.gb_inst.gbmodule_inst.gbcontrol_inst.gbcontrol_config.num_timestep_1 = to_ac(flex_i.flex_gb_control_num_timestep_1);
    dut.pe_ptrs[0]->pemodule_inst.pecore_inst.pe_config.is_valid = to_ac(flex_i.flex_pe0_rnn_layer_sizing_is_valid);
    dut.pe_ptrs[1]->pemodule_inst.pecore_inst.pe_config.is_valid = to_ac(flex_i.flex_pe1_rnn_layer_sizing_is_valid);
    dut.pe_ptrs[2]->pemodule_inst.pecore_inst.pe_config.is_valid = to_ac(flex_i.flex_pe2_rnn_layer_sizing_is_valid);
    dut.pe_ptrs[3]->pemodule_inst.pecore_inst.pe_config.is_valid = to_ac(flex_i.flex_pe3_rnn_layer_sizing_is_valid);
    dut.pe_ptrs[0]->pemodule_inst.pecore_inst.pe_config.is_zero_first = to_ac(flex_i.flex_pe0_rnn_layer_sizing_is_zero_first);
    dut.pe_ptrs[1]->pemodule_inst.pecore_inst.pe_config.is_zero_first = to_ac(flex_i.flex_pe1_rnn_layer_sizing_is_zero_first);
    dut.pe_ptrs[2]->pemodule_inst.pecore_inst.pe_config.is_zero_first = to_ac(flex_i.flex_pe2_rnn_layer_sizing_is_zero_first);
    dut.pe_ptrs[3]->pemodule_inst.pecore_inst.pe_config.is_zero_first = to_ac(flex_i.flex_pe3_rnn_layer_sizing_is_zero_first);
    dut.pe_ptrs[0]->pemodule_inst.pecore_inst.pe_config.is_cluster = to_ac(flex_i.flex_pe0_rnn_layer_sizing_is_cluster);
    dut.pe_ptrs[1]->pemodule_inst.pecore_inst.pe_config.is_cluster = to_ac(flex_i.flex_pe1_rnn_layer_sizing_is_cluster);
    dut.pe_ptrs[2]->pemodule_inst.pecore_inst.pe_config.is_cluster = to_ac(flex_i.flex_pe2_rnn_layer_sizing_is_cluster);
    dut.pe_ptrs[3]->pemodule_inst.pecore_inst.pe_config.is_cluster = to_ac(flex_i.flex_pe3_rnn_layer_sizing_is_cluster);
    dut.pe_ptrs[0]->pemodule_inst.pecore_inst.pe_config.is_bias = to_ac(flex_i.flex_pe0_rnn_layer_sizing_is_bias);
    dut.pe_ptrs[1]->pemodule_inst.pecore_inst.pe_config.is_bias = to_ac(flex_i.flex_pe1_rnn_layer_sizing_is_bias);
    dut.pe_ptrs[2]->pemodule_inst.pecore_inst.pe_config.is_bias = to_ac(flex_i.flex_pe2_rnn_layer_sizing_is_bias);
    dut.pe_ptrs[3]->pemodule_inst.pecore_inst.pe_config.is_bias = to_ac(flex_i.flex_pe3_rnn_layer_sizing_is_bias);
    dut.pe_ptrs[0]->pemodule_inst.pecore_inst.pe_config.num_manager = to_ac(flex_i.flex_pe0_rnn_layer_sizing_num_manager);
    dut.pe_ptrs[1]->pemodule_inst.pecore_inst.pe_config.num_manager = to_ac(flex_i.flex_pe1_rnn_layer_sizing_num_manager);
    dut.pe_ptrs[2]->pemodule_inst.pecore_inst.pe_config.num_manager = to_ac(flex_i.flex_pe2_rnn_layer_sizing_num_manager);
    dut.pe_ptrs[3]->pemodule_inst.pecore_inst.pe_config.num_manager = to_ac(flex_i.flex_pe3_rnn_layer_sizing_num_manager);
    dut.pe_ptrs[0]->pemodule_inst.pecore_inst.pe_config.num_output = to_ac(flex_i.flex_pe0_rnn_layer_sizing_num_output);
    dut.pe_ptrs[1]->pemodule_inst.pecore_inst.pe_config.num_output = to_ac(flex_i.flex_pe1_rnn_layer_sizing_num_output);
    dut.pe_ptrs[2]->pemodule_inst.pecore_inst.pe_config.num_output = to_ac(flex_i.flex_pe2_rnn_layer_sizing_num_output);
    dut.pe_ptrs[3]->pemodule_inst.pecore_inst.pe_config.num_output = to_ac(flex_i.flex_pe3_rnn_layer_sizing_num_output);
    dut.pe_ptrs[0]->pemodule_inst.pecore_inst.pe_manager[0].zero_active = to_ac(flex_i.flex_pe0_mem_mngr_first_zero_active);
    dut.pe_ptrs[1]->pemodule_inst.pecore_inst.pe_manager[0].zero_active = to_ac(flex_i.flex_pe1_mem_mngr_first_zero_active);
    dut.pe_ptrs[2]->pemodule_inst.pecore_inst.pe_manager[0].zero_active = to_ac(flex_i.flex_pe2_mem_mngr_first_zero_active);
    dut.pe_ptrs[3]->pemodule_inst.pecore_inst.pe_manager[0].zero_active = to_ac(flex_i.flex_pe3_mem_mngr_first_zero_active);
    dut.pe_ptrs[0]->pemodule_inst.pecore_inst.pe_manager[0].adplfloat_bias_weight = to_ac(flex_i.flex_pe0_mem_mngr_first_adpfloat_bias_w);
    dut.pe_ptrs[1]->pemodule_inst.pecore_inst.pe_manager[0].adplfloat_bias_weight = to_ac(flex_i.flex_pe1_mem_mngr_first_adpfloat_bias_w);
    dut.pe_ptrs[2]->pemodule_inst.pecore_inst.pe_manager[0].adplfloat_bias_weight = to_ac(flex_i.flex_pe2_mem_mngr_first_adpfloat_bias_w);
    dut.pe_ptrs[3]->pemodule_inst.pecore_inst.pe_manager[0].adplfloat_bias_weight = to_ac(flex_i.flex_pe3_mem_mngr_first_adpfloat_bias_w);
    dut.pe_ptrs[0]->pemodule_inst.pecore_inst.pe_manager[0].adplfloat_bias_bias = to_ac(flex_i.flex_pe0_mem_mngr_first_adpfloat_bias_b);
    dut.pe_ptrs[1]->pemodule_inst.pecore_inst.pe_manager[0].adplfloat_bias_bias = to_ac(flex_i.flex_pe1_mem_mngr_first_adpfloat_bias_b);
    dut.pe_ptrs[2]->pemodule_inst.pecore_inst.pe_manager[0].adplfloat_bias_bias = to_ac(flex_i.flex_pe2_mem_mngr_first_adpfloat_bias_b);
    dut.pe_ptrs[3]->pemodule_inst.pecore_inst.pe_manager[0].adplfloat_bias_bias = to_ac(flex_i.flex_pe3_mem_mngr_first_adpfloat_bias_b);
    dut.pe_ptrs[0]->pemodule_inst.pecore_inst.pe_manager[0].adplfloat_bias_input = to_ac(flex_i.flex_pe0_mem_mngr_first_num_input);
    dut.pe_ptrs[1]->pemodule_inst.pecore_inst.pe_manager[0].adplfloat_bias_input = to_ac(flex_i.flex_pe1_mem_mngr_first_num_input);
    dut.pe_ptrs[2]->pemodule_inst.pecore_inst.pe_manager[0].adplfloat_bias_input = to_ac(flex_i.flex_pe2_mem_mngr_first_num_input);
    dut.pe_ptrs[3]->pemodule_inst.pecore_inst.pe_manager[0].adplfloat_bias_input = to_ac(flex_i.flex_pe3_mem_mngr_first_num_input);
    dut.pe_ptrs[0]->pemodule_inst.pecore_inst.pe_manager[0].num_input = to_ac(flex_i.flex_pe0_mem_mngr_first_base_weight);
    dut.pe_ptrs[1]->pemodule_inst.pecore_inst.pe_manager[0].num_input = to_ac(flex_i.flex_pe1_mem_mngr_first_base_weight);
    dut.pe_ptrs[2]->pemodule_inst.pecore_inst.pe_manager[0].num_input = to_ac(flex_i.flex_pe2_mem_mngr_first_base_weight);
    dut.pe_ptrs[3]->pemodule_inst.pecore_inst.pe_manager[0].num_input = to_ac(flex_i.flex_pe3_mem_mngr_first_base_weight);
    dut.pe_ptrs[0]->pemodule_inst.pecore_inst.pe_manager[0].base_weight = to_ac(flex_i.flex_pe0_mem_mngr_first_base_weight);
    dut.pe_ptrs[1]->pemodule_inst.pecore_inst.pe_manager[0].base_weight = to_ac(flex_i.flex_pe1_mem_mngr_first_base_weight);
    dut.pe_ptrs[2]->pemodule_inst.pecore_inst.pe_manager[0].base_weight = to_ac(flex_i.flex_pe2_mem_mngr_first_base_weight);
    dut.pe_ptrs[3]->pemodule_inst.pecore_inst.pe_manager[0].base_weight = to_ac(flex_i.flex_pe3_mem_mngr_first_base_weight);
    dut.pe_ptrs[0]->pemodule_inst.pecore_inst.pe_manager[0].base_bias = to_ac(flex_i.flex_pe0_mem_mngr_first_base_bias);
    dut.pe_ptrs[1]->pemodule_inst.pecore_inst.pe_manager[0].base_bias = to_ac(flex_i.flex_pe1_mem_mngr_first_base_bias);
    dut.pe_ptrs[2]->pemodule_inst.pecore_inst.pe_manager[0].base_bias = to_ac(flex_i.flex_pe2_mem_mngr_first_base_bias);
    dut.pe_ptrs[3]->pemodule_inst.pecore_inst.pe_manager[0].base_bias = to_ac(flex_i.flex_pe3_mem_mngr_first_base_bias);
    dut.pe_ptrs[0]->pemodule_inst.pecore_inst.pe_manager[0].base_input = to_ac(flex_i.flex_pe0_mem_mngr_first_base_input);
    dut.pe_ptrs[1]->pemodule_inst.pecore_inst.pe_manager[0].base_input = to_ac(flex_i.flex_pe1_mem_mngr_first_base_input);
    dut.pe_ptrs[2]->pemodule_inst.pecore_inst.pe_manager[0].base_input = to_ac(flex_i.flex_pe2_mem_mngr_first_base_input);
    dut.pe_ptrs[3]->pemodule_inst.pecore_inst.pe_manager[0].base_input = to_ac(flex_i.flex_pe3_mem_mngr_first_base_input);
    dut.pe_ptrs[0]->pemodule_inst.pecore_inst.pe_manager[1].zero_active = to_ac(flex_i.flex_pe0_mem_mngr_second_zero_active);
    dut.pe_ptrs[1]->pemodule_inst.pecore_inst.pe_manager[1].zero_active = to_ac(flex_i.flex_pe1_mem_mngr_second_zero_active);
    dut.pe_ptrs[2]->pemodule_inst.pecore_inst.pe_manager[1].zero_active = to_ac(flex_i.flex_pe2_mem_mngr_second_zero_active);
    dut.pe_ptrs[3]->pemodule_inst.pecore_inst.pe_manager[1].zero_active = to_ac(flex_i.flex_pe3_mem_mngr_second_zero_active);
    dut.pe_ptrs[0]->pemodule_inst.pecore_inst.pe_manager[1].adplfloat_bias_weight = to_ac(flex_i.flex_pe0_mem_mngr_second_adpfloat_bias_w);
    dut.pe_ptrs[1]->pemodule_inst.pecore_inst.pe_manager[1].adplfloat_bias_weight = to_ac(flex_i.flex_pe1_mem_mngr_second_adpfloat_bias_w);
    dut.pe_ptrs[2]->pemodule_inst.pecore_inst.pe_manager[1].adplfloat_bias_weight = to_ac(flex_i.flex_pe2_mem_mngr_second_adpfloat_bias_w);
    dut.pe_ptrs[3]->pemodule_inst.pecore_inst.pe_manager[1].adplfloat_bias_weight = to_ac(flex_i.flex_pe3_mem_mngr_second_adpfloat_bias_w);
    dut.pe_ptrs[0]->pemodule_inst.pecore_inst.pe_manager[1].adplfloat_bias_bias = to_ac(flex_i.flex_pe0_mem_mngr_second_adpfloat_bias_b);
    dut.pe_ptrs[1]->pemodule_inst.pecore_inst.pe_manager[1].adplfloat_bias_bias = to_ac(flex_i.flex_pe1_mem_mngr_second_adpfloat_bias_b);
    dut.pe_ptrs[2]->pemodule_inst.pecore_inst.pe_manager[1].adplfloat_bias_bias = to_ac(flex_i.flex_pe2_mem_mngr_second_adpfloat_bias_b);
    dut.pe_ptrs[3]->pemodule_inst.pecore_inst.pe_manager[1].adplfloat_bias_bias = to_ac(flex_i.flex_pe3_mem_mngr_second_adpfloat_bias_b);
    dut.pe_ptrs[0]->pemodule_inst.pecore_inst.pe_manager[1].adplfloat_bias_input = to_ac(flex_i.flex_pe0_mem_mngr_second_adpfloat_bias_i);
    dut.pe_ptrs[1]->pemodule_inst.pecore_inst.pe_manager[1].adplfloat_bias_input = to_ac(flex_i.flex_pe1_mem_mngr_second_adpfloat_bias_i);
    dut.pe_ptrs[2]->pemodule_inst.pecore_inst.pe_manager[1].adplfloat_bias_input = to_ac(flex_i.flex_pe2_mem_mngr_second_adpfloat_bias_i);
    dut.pe_ptrs[3]->pemodule_inst.pecore_inst.pe_manager[1].adplfloat_bias_input = to_ac(flex_i.flex_pe3_mem_mngr_second_adpfloat_bias_i);
    dut.pe_ptrs[0]->pemodule_inst.pecore_inst.pe_manager[1].num_input = to_ac(flex_i.flex_pe0_mem_mngr_second_num_input);
    dut.pe_ptrs[1]->pemodule_inst.pecore_inst.pe_manager[1].num_input = to_ac(flex_i.flex_pe1_mem_mngr_second_num_input);
    dut.pe_ptrs[2]->pemodule_inst.pecore_inst.pe_manager[1].num_input = to_ac(flex_i.flex_pe2_mem_mngr_second_num_input);
    dut.pe_ptrs[3]->pemodule_inst.pecore_inst.pe_manager[1].num_input = to_ac(flex_i.flex_pe3_mem_mngr_second_num_input);
    dut.pe_ptrs[0]->pemodule_inst.pecore_inst.pe_manager[1].base_weight = to_ac(flex_i.flex_pe0_mem_mngr_second_base_weight);
    dut.pe_ptrs[1]->pemodule_inst.pecore_inst.pe_manager[1].base_weight = to_ac(flex_i.flex_pe1_mem_mngr_second_base_weight);
    dut.pe_ptrs[2]->pemodule_inst.pecore_inst.pe_manager[1].base_weight = to_ac(flex_i.flex_pe2_mem_mngr_second_base_weight);
    dut.pe_ptrs[3]->pemodule_inst.pecore_inst.pe_manager[1].base_weight = to_ac(flex_i.flex_pe3_mem_mngr_second_base_weight);
    dut.pe_ptrs[0]->pemodule_inst.pecore_inst.pe_manager[1].base_bias = to_ac(flex_i.flex_pe0_mem_mngr_second_base_bias);
    dut.pe_ptrs[1]->pemodule_inst.pecore_inst.pe_manager[1].base_bias = to_ac(flex_i.flex_pe1_mem_mngr_second_base_bias);
    dut.pe_ptrs[2]->pemodule_inst.pecore_inst.pe_manager[1].base_bias = to_ac(flex_i.flex_pe2_mem_mngr_second_base_bias);
    dut.pe_ptrs[3]->pemodule_inst.pecore_inst.pe_manager[1].base_bias = to_ac(flex_i.flex_pe3_mem_mngr_second_base_bias);
    dut.pe_ptrs[0]->pemodule_inst.pecore_inst.pe_manager[1].base_input = to_ac(flex_i.flex_pe0_mem_mngr_second_base_input);
    dut.pe_ptrs[1]->pemodule_inst.pecore_inst.pe_manager[1].base_input = to_ac(flex_i.flex_pe1_mem_mngr_second_base_input);
    dut.pe_ptrs[2]->pemodule_inst.pecore_inst.pe_manager[1].base_input = to_ac(flex_i.flex_pe2_mem_mngr_second_base_input);
    dut.pe_ptrs[3]->pemodule_inst.pecore_inst.pe_manager[1].base_input = to_ac(flex_i.flex_pe3_mem_mngr_second_base_input);
    dut.pe_ptrs[0]->pemodule_inst.act_inst.act_config.is_valid = to_ac(flex_i.flex_pe0_act_mngr_is_valid);
    dut.pe_ptrs[1]->pemodule_inst.act_inst.act_config.is_valid = to_ac(flex_i.flex_pe1_act_mngr_is_valid);
    dut.pe_ptrs[2]->pemodule_inst.act_inst.act_config.is_valid = to_ac(flex_i.flex_pe2_act_mngr_is_valid);
    dut.pe_ptrs[3]->pemodule_inst.act_inst.act_config.is_valid = to_ac(flex_i.flex_pe3_act_mngr_is_valid);
    dut.pe_ptrs[0]->pemodule_inst.act_inst.act_config.is_zero_first = to_ac(flex_i.flex_pe0_act_mngr_is_zero_first);
    dut.pe_ptrs[1]->pemodule_inst.act_inst.act_config.is_zero_first = to_ac(flex_i.flex_pe1_act_mngr_is_zero_first);
    dut.pe_ptrs[2]->pemodule_inst.act_inst.act_config.is_zero_first = to_ac(flex_i.flex_pe2_act_mngr_is_zero_first);
    dut.pe_ptrs[3]->pemodule_inst.act_inst.act_config.is_zero_first = to_ac(flex_i.flex_pe3_act_mngr_is_zero_first);
    dut.pe_ptrs[0]->pemodule_inst.act_inst.act_config.adpfloat_bias = to_ac(flex_i.flex_pe0_act_mngr_adpfloat_bias);
    dut.pe_ptrs[1]->pemodule_inst.act_inst.act_config.adpfloat_bias = to_ac(flex_i.flex_pe1_act_mngr_adpfloat_bias);
    dut.pe_ptrs[2]->pemodule_inst.act_inst.act_config.adpfloat_bias = to_ac(flex_i.flex_pe2_act_mngr_adpfloat_bias);
    dut.pe_ptrs[3]->pemodule_inst.act_inst.act_config.adpfloat_bias = to_ac(flex_i.flex_pe3_act_mngr_adpfloat_bias);
    dut.pe_ptrs[0]->pemodule_inst.act_inst.act_config.num_inst = to_ac(flex_i.flex_pe0_act_mngr_num_inst);
    dut.pe_ptrs[1]->pemodule_inst.act_inst.act_config.num_inst = to_ac(flex_i.flex_pe1_act_mngr_num_inst);
    dut.pe_ptrs[2]->pemodule_inst.act_inst.act_config.num_inst = to_ac(flex_i.flex_pe2_act_mngr_num_inst);
    dut.pe_ptrs[3]->pemodule_inst.act_inst.act_config.num_inst = to_ac(flex_i.flex_pe3_act_mngr_num_inst);
    dut.pe_ptrs[0]->pemodule_inst.act_inst.act_config.num_output = to_ac(flex_i.flex_pe0_act_mngr_num_output);
    dut.pe_ptrs[1]->pemodule_inst.act_inst.act_config.num_output = to_ac(flex_i.flex_pe1_act_mngr_num_output);
    dut.pe_ptrs[2]->pemodule_inst.act_inst.act_config.num_output = to_ac(flex_i.flex_pe2_act_mngr_num_output);
    dut.pe_ptrs[3]->pemodule_inst.act_inst.act_config.num_output = to_ac(flex_i.flex_pe3_act_mngr_num_output);
    dut.pe_ptrs[0]->pemodule_inst.act_inst.act_config.buffer_addr_base = to_ac(flex_i.flex_pe0_act_mngr_buffer_addr_base);
    dut.pe_ptrs[1]->pemodule_inst.act_inst.act_config.buffer_addr_base = to_ac(flex_i.flex_pe1_act_mngr_buffer_addr_base);
    dut.pe_ptrs[2]->pemodule_inst.act_inst.act_config.buffer_addr_base = to_ac(flex_i.flex_pe2_act_mngr_buffer_addr_base);
    dut.pe_ptrs[3]->pemodule_inst.act_inst.act_config.buffer_addr_base = to_ac(flex_i.flex_pe3_act_mngr_buffer_addr_base);
    dut.pe_ptrs[0]->pemodule_inst.act_inst.act_config.output_addr_base = to_ac(flex_i.flex_pe0_act_mngr_output_addr_base);
    dut.pe_ptrs[1]->pemodule_inst.act_inst.act_config.output_addr_base = to_ac(flex_i.flex_pe1_act_mngr_output_addr_base);
    dut.pe_ptrs[2]->pemodule_inst.act_inst.act_config.output_addr_base = to_ac(flex_i.flex_pe2_act_mngr_output_addr_base);
    dut.pe_ptrs[3]->pemodule_inst.act_inst.act_config.output_addr_base = to_ac(flex_i.flex_pe3_act_mngr_output_addr_base);
    dut.pe_ptrs[0]->pemodule_inst.act_inst.act_config.inst_regs[0] = to_ac(flex_i.flex_pe0_act_vector_0_15_Inst0);
    dut.pe_ptrs[1]->pemodule_inst.act_inst.act_config.inst_regs[0] = to_ac(flex_i.flex_pe1_act_vector_0_15_Inst0);
    dut.pe_ptrs[2]->pemodule_inst.act_inst.act_config.inst_regs[0] = to_ac(flex_i.flex_pe2_act_vector_0_15_Inst0);
    dut.pe_ptrs[3]->pemodule_inst.act_inst.act_config.inst_regs[0] = to_ac(flex_i.flex_pe3_act_vector_0_15_Inst0);
    dut.pe_ptrs[0]->pemodule_inst.act_inst.act_config.inst_regs[1] = to_ac(flex_i.flex_pe0_act_vector_0_15_Inst1);
    dut.pe_ptrs[1]->pemodule_inst.act_inst.act_config.inst_regs[1] = to_ac(flex_i.flex_pe1_act_vector_0_15_Inst1);
    dut.pe_ptrs[2]->pemodule_inst.act_inst.act_config.inst_regs[1] = to_ac(flex_i.flex_pe2_act_vector_0_15_Inst1);
    dut.pe_ptrs[3]->pemodule_inst.act_inst.act_config.inst_regs[1] = to_ac(flex_i.flex_pe3_act_vector_0_15_Inst1);
    dut.pe_ptrs[0]->pemodule_inst.act_inst.act_config.inst_regs[2] = to_ac(flex_i.flex_pe0_act_vector_0_15_Inst2);
    dut.pe_ptrs[1]->pemodule_inst.act_inst.act_config.inst_regs[2] = to_ac(flex_i.flex_pe1_act_vector_0_15_Inst2);
    dut.pe_ptrs[2]->pemodule_inst.act_inst.act_config.inst_regs[2] = to_ac(flex_i.flex_pe2_act_vector_0_15_Inst2);
    dut.pe_ptrs[3]->pemodule_inst.act_inst.act_config.inst_regs[2] = to_ac(flex_i.flex_pe3_act_vector_0_15_Inst2);
    dut.pe_ptrs[0]->pemodule_inst.act_inst.act_config.inst_regs[3] = to_ac(flex_i.flex_pe0_act_vector_0_15_Inst3);
    dut.pe_ptrs[1]->pemodule_inst.act_inst.act_config.inst_regs[3] = to_ac(flex_i.flex_pe1_act_vector_0_15_Inst3);
    dut.pe_ptrs[2]->pemodule_inst.act_inst.act_config.inst_regs[3] = to_ac(flex_i.flex_pe2_act_vector_0_15_Inst3);
    dut.pe_ptrs[3]->pemodule_inst.act_inst.act_config.inst_regs[3] = to_ac(flex_i.flex_pe3_act_vector_0_15_Inst3);
    dut.pe_ptrs[0]->pemodule_inst.act_inst.act_config.inst_regs[4] = to_ac(flex_i.flex_pe0_act_vector_0_15_Inst4);
    dut.pe_ptrs[1]->pemodule_inst.act_inst.act_config.inst_regs[4] = to_ac(flex_i.flex_pe1_act_vector_0_15_Inst4);
    dut.pe_ptrs[2]->pemodule_inst.act_inst.act_config.inst_regs[4] = to_ac(flex_i.flex_pe2_act_vector_0_15_Inst4);
    dut.pe_ptrs[3]->pemodule_inst.act_inst.act_config.inst_regs[4] = to_ac(flex_i.flex_pe3_act_vector_0_15_Inst4);
    dut.pe_ptrs[0]->pemodule_inst.act_inst.act_config.inst_regs[5] = to_ac(flex_i.flex_pe0_act_vector_0_15_Inst5);
    dut.pe_ptrs[1]->pemodule_inst.act_inst.act_config.inst_regs[5] = to_ac(flex_i.flex_pe1_act_vector_0_15_Inst5);
    dut.pe_ptrs[2]->pemodule_inst.act_inst.act_config.inst_regs[5] = to_ac(flex_i.flex_pe2_act_vector_0_15_Inst5);
    dut.pe_ptrs[3]->pemodule_inst.act_inst.act_config.inst_regs[5] = to_ac(flex_i.flex_pe3_act_vector_0_15_Inst5);
    dut.pe_ptrs[0]->pemodule_inst.act_inst.act_config.inst_regs[6] = to_ac(flex_i.flex_pe0_act_vector_0_15_Inst6);
    dut.pe_ptrs[1]->pemodule_inst.act_inst.act_config.inst_regs[6] = to_ac(flex_i.flex_pe1_act_vector_0_15_Inst6);
    dut.pe_ptrs[2]->pemodule_inst.act_inst.act_config.inst_regs[6] = to_ac(flex_i.flex_pe2_act_vector_0_15_Inst6);
    dut.pe_ptrs[3]->pemodule_inst.act_inst.act_config.inst_regs[6] = to_ac(flex_i.flex_pe3_act_vector_0_15_Inst6);
    dut.pe_ptrs[0]->pemodule_inst.act_inst.act_config.inst_regs[7] = to_ac(flex_i.flex_pe0_act_vector_0_15_Inst7);
    dut.pe_ptrs[1]->pemodule_inst.act_inst.act_config.inst_regs[7] = to_ac(flex_i.flex_pe1_act_vector_0_15_Inst7);
    dut.pe_ptrs[2]->pemodule_inst.act_inst.act_config.inst_regs[7] = to_ac(flex_i.flex_pe2_act_vector_0_15_Inst7);
    dut.pe_ptrs[3]->pemodule_inst.act_inst.act_config.inst_regs[7] = to_ac(flex_i.flex_pe3_act_vector_0_15_Inst7);
    dut.pe_ptrs[0]->pemodule_inst.act_inst.act_config.inst_regs[8] = to_ac(flex_i.flex_pe0_act_vector_0_15_Inst8);
    dut.pe_ptrs[1]->pemodule_inst.act_inst.act_config.inst_regs[8] = to_ac(flex_i.flex_pe1_act_vector_0_15_Inst8);
    dut.pe_ptrs[2]->pemodule_inst.act_inst.act_config.inst_regs[8] = to_ac(flex_i.flex_pe2_act_vector_0_15_Inst8);
    dut.pe_ptrs[3]->pemodule_inst.act_inst.act_config.inst_regs[8] = to_ac(flex_i.flex_pe3_act_vector_0_15_Inst8);
    dut.pe_ptrs[0]->pemodule_inst.act_inst.act_config.inst_regs[9] = to_ac(flex_i.flex_pe0_act_vector_0_15_Inst9);
    dut.pe_ptrs[1]->pemodule_inst.act_inst.act_config.inst_regs[9] = to_ac(flex_i.flex_pe1_act_vector_0_15_Inst9);
    dut.pe_ptrs[2]->pemodule_inst.act_inst.act_config.inst_regs[9] = to_ac(flex_i.flex_pe2_act_vector_0_15_Inst9);
    dut.pe_ptrs[3]->pemodule_inst.act_inst.act_config.inst_regs[9] = to_ac(flex_i.flex_pe3_act_vector_0_15_Inst9);
    dut.pe_ptrs[0]->pemodule_inst.act_inst.act_config.inst_regs[10] = to_ac(flex_i.flex_pe0_act_vector_0_15_Inst10);
    dut.pe_ptrs[1]->pemodule_inst.act_inst.act_config.inst_regs[10] = to_ac(flex_i.flex_pe1_act_vector_0_15_Inst10);
    dut.pe_ptrs[2]->pemodule_inst.act_inst.act_config.inst_regs[10] = to_ac(flex_i.flex_pe2_act_vector_0_15_Inst10);
    dut.pe_ptrs[3]->pemodule_inst.act_inst.act_config.inst_regs[10] = to_ac(flex_i.flex_pe3_act_vector_0_15_Inst10);
    dut.pe_ptrs[0]->pemodule_inst.act_inst.act_config.inst_regs[11] = to_ac(flex_i.flex_pe0_act_vector_0_15_Inst11);
    dut.pe_ptrs[1]->pemodule_inst.act_inst.act_config.inst_regs[11] = to_ac(flex_i.flex_pe1_act_vector_0_15_Inst11);
    dut.pe_ptrs[2]->pemodule_inst.act_inst.act_config.inst_regs[11] = to_ac(flex_i.flex_pe2_act_vector_0_15_Inst11);
    dut.pe_ptrs[3]->pemodule_inst.act_inst.act_config.inst_regs[11] = to_ac(flex_i.flex_pe3_act_vector_0_15_Inst11);
    dut.pe_ptrs[0]->pemodule_inst.act_inst.act_config.inst_regs[12] = to_ac(flex_i.flex_pe0_act_vector_0_15_Inst12);
    dut.pe_ptrs[1]->pemodule_inst.act_inst.act_config.inst_regs[12] = to_ac(flex_i.flex_pe1_act_vector_0_15_Inst12);
    dut.pe_ptrs[2]->pemodule_inst.act_inst.act_config.inst_regs[12] = to_ac(flex_i.flex_pe2_act_vector_0_15_Inst12);
    dut.pe_ptrs[3]->pemodule_inst.act_inst.act_config.inst_regs[12] = to_ac(flex_i.flex_pe3_act_vector_0_15_Inst12);
    dut.pe_ptrs[0]->pemodule_inst.act_inst.act_config.inst_regs[13] = to_ac(flex_i.flex_pe0_act_vector_0_15_Inst13);
    dut.pe_ptrs[1]->pemodule_inst.act_inst.act_config.inst_regs[13] = to_ac(flex_i.flex_pe1_act_vector_0_15_Inst13);
    dut.pe_ptrs[2]->pemodule_inst.act_inst.act_config.inst_regs[13] = to_ac(flex_i.flex_pe2_act_vector_0_15_Inst13);
    dut.pe_ptrs[3]->pemodule_inst.act_inst.act_config.inst_regs[13] = to_ac(flex_i.flex_pe3_act_vector_0_15_Inst13);
    dut.pe_ptrs[0]->pemodule_inst.act_inst.act_config.inst_regs[14] = to_ac(flex_i.flex_pe0_act_vector_0_15_Inst14);
    dut.pe_ptrs[1]->pemodule_inst.act_inst.act_config.inst_regs[14] = to_ac(flex_i.flex_pe1_act_vector_0_15_Inst14);
    dut.pe_ptrs[2]->pemodule_inst.act_inst.act_config.inst_regs[14] = to_ac(flex_i.flex_pe2_act_vector_0_15_Inst14);
    dut.pe_ptrs[3]->pemodule_inst.act_inst.act_config.inst_regs[14] = to_ac(flex_i.flex_pe3_act_vector_0_15_Inst14);
    dut.pe_ptrs[0]->pemodule_inst.act_inst.act_config.inst_regs[15] = to_ac(flex_i.flex_pe0_act_vector_0_15_Inst15);
    dut.pe_ptrs[1]->pemodule_inst.act_inst.act_config.inst_regs[15] = to_ac(flex_i.flex_pe1_act_vector_0_15_Inst15);
    dut.pe_ptrs[2]->pemodule_inst.act_inst.act_config.inst_regs[15] = to_ac(flex_i.flex_pe2_act_vector_0_15_Inst15);
    dut.pe_ptrs[3]->pemodule_inst.act_inst.act_config.inst_regs[15] = to_ac(flex_i.flex_pe3_act_vector_0_15_Inst15);
    dut.pe_ptrs[0]->pemodule_inst.act_inst.act_config.inst_regs[16] = to_ac(flex_i.flex_pe0_act_vector_16_31_Inst0);
    dut.pe_ptrs[1]->pemodule_inst.act_inst.act_config.inst_regs[16] = to_ac(flex_i.flex_pe1_act_vector_16_31_Inst0);
    dut.pe_ptrs[2]->pemodule_inst.act_inst.act_config.inst_regs[16] = to_ac(flex_i.flex_pe2_act_vector_16_31_Inst0);
    dut.pe_ptrs[3]->pemodule_inst.act_inst.act_config.inst_regs[16] = to_ac(flex_i.flex_pe3_act_vector_16_31_Inst0);
    dut.pe_ptrs[0]->pemodule_inst.act_inst.act_config.inst_regs[17] = to_ac(flex_i.flex_pe0_act_vector_16_31_Inst1);
    dut.pe_ptrs[1]->pemodule_inst.act_inst.act_config.inst_regs[17] = to_ac(flex_i.flex_pe1_act_vector_16_31_Inst1);
    dut.pe_ptrs[2]->pemodule_inst.act_inst.act_config.inst_regs[17] = to_ac(flex_i.flex_pe2_act_vector_16_31_Inst1);
    dut.pe_ptrs[3]->pemodule_inst.act_inst.act_config.inst_regs[17] = to_ac(flex_i.flex_pe3_act_vector_16_31_Inst1);
    dut.pe_ptrs[0]->pemodule_inst.act_inst.act_config.inst_regs[18] = to_ac(flex_i.flex_pe0_act_vector_16_31_Inst2);
    dut.pe_ptrs[1]->pemodule_inst.act_inst.act_config.inst_regs[18] = to_ac(flex_i.flex_pe1_act_vector_16_31_Inst2);
    dut.pe_ptrs[2]->pemodule_inst.act_inst.act_config.inst_regs[18] = to_ac(flex_i.flex_pe2_act_vector_16_31_Inst2);
    dut.pe_ptrs[3]->pemodule_inst.act_inst.act_config.inst_regs[18] = to_ac(flex_i.flex_pe3_act_vector_16_31_Inst2);
    dut.pe_ptrs[0]->pemodule_inst.act_inst.act_config.inst_regs[19] = to_ac(flex_i.flex_pe0_act_vector_16_31_Inst3);
    dut.pe_ptrs[1]->pemodule_inst.act_inst.act_config.inst_regs[19] = to_ac(flex_i.flex_pe1_act_vector_16_31_Inst3);
    dut.pe_ptrs[2]->pemodule_inst.act_inst.act_config.inst_regs[19] = to_ac(flex_i.flex_pe2_act_vector_16_31_Inst3);
    dut.pe_ptrs[3]->pemodule_inst.act_inst.act_config.inst_regs[19] = to_ac(flex_i.flex_pe3_act_vector_16_31_Inst3);
    dut.pe_ptrs[0]->pemodule_inst.act_inst.act_config.inst_regs[20] = to_ac(flex_i.flex_pe0_act_vector_16_31_Inst4);
    dut.pe_ptrs[1]->pemodule_inst.act_inst.act_config.inst_regs[20] = to_ac(flex_i.flex_pe1_act_vector_16_31_Inst4);
    dut.pe_ptrs[2]->pemodule_inst.act_inst.act_config.inst_regs[20] = to_ac(flex_i.flex_pe2_act_vector_16_31_Inst4);
    dut.pe_ptrs[3]->pemodule_inst.act_inst.act_config.inst_regs[20] = to_ac(flex_i.flex_pe3_act_vector_16_31_Inst4);
    dut.pe_ptrs[0]->pemodule_inst.act_inst.act_config.inst_regs[21] = to_ac(flex_i.flex_pe0_act_vector_16_31_Inst5);
    dut.pe_ptrs[1]->pemodule_inst.act_inst.act_config.inst_regs[21] = to_ac(flex_i.flex_pe1_act_vector_16_31_Inst5);
    dut.pe_ptrs[2]->pemodule_inst.act_inst.act_config.inst_regs[21] = to_ac(flex_i.flex_pe2_act_vector_16_31_Inst5);
    dut.pe_ptrs[3]->pemodule_inst.act_inst.act_config.inst_regs[21] = to_ac(flex_i.flex_pe3_act_vector_16_31_Inst5);
    dut.pe_ptrs[0]->pemodule_inst.act_inst.act_config.inst_regs[22] = to_ac(flex_i.flex_pe0_act_vector_16_31_Inst6);
    dut.pe_ptrs[1]->pemodule_inst.act_inst.act_config.inst_regs[22] = to_ac(flex_i.flex_pe1_act_vector_16_31_Inst6);
    dut.pe_ptrs[2]->pemodule_inst.act_inst.act_config.inst_regs[22] = to_ac(flex_i.flex_pe2_act_vector_16_31_Inst6);
    dut.pe_ptrs[3]->pemodule_inst.act_inst.act_config.inst_regs[22] = to_ac(flex_i.flex_pe3_act_vector_16_31_Inst6);
    dut.pe_ptrs[0]->pemodule_inst.act_inst.act_config.inst_regs[23] = to_ac(flex_i.flex_pe0_act_vector_16_31_Inst7);
    dut.pe_ptrs[1]->pemodule_inst.act_inst.act_config.inst_regs[23] = to_ac(flex_i.flex_pe1_act_vector_16_31_Inst7);
    dut.pe_ptrs[2]->pemodule_inst.act_inst.act_config.inst_regs[23] = to_ac(flex_i.flex_pe2_act_vector_16_31_Inst7);
    dut.pe_ptrs[3]->pemodule_inst.act_inst.act_config.inst_regs[23] = to_ac(flex_i.flex_pe3_act_vector_16_31_Inst7);
    dut.pe_ptrs[0]->pemodule_inst.act_inst.act_config.inst_regs[24] = to_ac(flex_i.flex_pe0_act_vector_16_31_Inst8);
    dut.pe_ptrs[1]->pemodule_inst.act_inst.act_config.inst_regs[24] = to_ac(flex_i.flex_pe1_act_vector_16_31_Inst8);
    dut.pe_ptrs[2]->pemodule_inst.act_inst.act_config.inst_regs[24] = to_ac(flex_i.flex_pe2_act_vector_16_31_Inst8);
    dut.pe_ptrs[3]->pemodule_inst.act_inst.act_config.inst_regs[24] = to_ac(flex_i.flex_pe3_act_vector_16_31_Inst8);
    dut.pe_ptrs[0]->pemodule_inst.act_inst.act_config.inst_regs[25] = to_ac(flex_i.flex_pe0_act_vector_16_31_Inst9);
    dut.pe_ptrs[1]->pemodule_inst.act_inst.act_config.inst_regs[25] = to_ac(flex_i.flex_pe1_act_vector_16_31_Inst9);
    dut.pe_ptrs[2]->pemodule_inst.act_inst.act_config.inst_regs[25] = to_ac(flex_i.flex_pe2_act_vector_16_31_Inst9);
    dut.pe_ptrs[3]->pemodule_inst.act_inst.act_config.inst_regs[25] = to_ac(flex_i.flex_pe3_act_vector_16_31_Inst9);
    dut.pe_ptrs[0]->pemodule_inst.act_inst.act_config.inst_regs[26] = to_ac(flex_i.flex_pe0_act_vector_16_31_Inst10);
    dut.pe_ptrs[1]->pemodule_inst.act_inst.act_config.inst_regs[26] = to_ac(flex_i.flex_pe1_act_vector_16_31_Inst10);
    dut.pe_ptrs[2]->pemodule_inst.act_inst.act_config.inst_regs[26] = to_ac(flex_i.flex_pe2_act_vector_16_31_Inst10);
    dut.pe_ptrs[3]->pemodule_inst.act_inst.act_config.inst_regs[26] = to_ac(flex_i.flex_pe3_act_vector_16_31_Inst10);
    dut.pe_ptrs[0]->pemodule_inst.act_inst.act_config.inst_regs[27] = to_ac(flex_i.flex_pe0_act_vector_16_31_Inst11);
    dut.pe_ptrs[1]->pemodule_inst.act_inst.act_config.inst_regs[27] = to_ac(flex_i.flex_pe1_act_vector_16_31_Inst11);
    dut.pe_ptrs[2]->pemodule_inst.act_inst.act_config.inst_regs[27] = to_ac(flex_i.flex_pe2_act_vector_16_31_Inst11);
    dut.pe_ptrs[3]->pemodule_inst.act_inst.act_config.inst_regs[27] = to_ac(flex_i.flex_pe3_act_vector_16_31_Inst11);
    dut.pe_ptrs[0]->pemodule_inst.act_inst.act_config.inst_regs[28] = to_ac(flex_i.flex_pe0_act_vector_16_31_Inst12);
    dut.pe_ptrs[1]->pemodule_inst.act_inst.act_config.inst_regs[28] = to_ac(flex_i.flex_pe1_act_vector_16_31_Inst12);
    dut.pe_ptrs[2]->pemodule_inst.act_inst.act_config.inst_regs[28] = to_ac(flex_i.flex_pe2_act_vector_16_31_Inst12);
    dut.pe_ptrs[3]->pemodule_inst.act_inst.act_config.inst_regs[28] = to_ac(flex_i.flex_pe3_act_vector_16_31_Inst12);
    dut.pe_ptrs[0]->pemodule_inst.act_inst.act_config.inst_regs[29] = to_ac(flex_i.flex_pe0_act_vector_16_31_Inst13);
    dut.pe_ptrs[1]->pemodule_inst.act_inst.act_config.inst_regs[29] = to_ac(flex_i.flex_pe1_act_vector_16_31_Inst13);
    dut.pe_ptrs[2]->pemodule_inst.act_inst.act_config.inst_regs[29] = to_ac(flex_i.flex_pe2_act_vector_16_31_Inst13);
    dut.pe_ptrs[3]->pemodule_inst.act_inst.act_config.inst_regs[29] = to_ac(flex_i.flex_pe3_act_vector_16_31_Inst13);
    dut.pe_ptrs[0]->pemodule_inst.act_inst.act_config.inst_regs[30] = to_ac(flex_i.flex_pe0_act_vector_16_31_Inst14);
    dut.pe_ptrs[1]->pemodule_inst.act_inst.act_config.inst_regs[30] = to_ac(flex_i.flex_pe1_act_vector_16_31_Inst14);
    dut.pe_ptrs[2]->pemodule_inst.act_inst.act_config.inst_regs[30] = to_ac(flex_i.flex_pe2_act_vector_16_31_Inst14);
    dut.pe_ptrs[3]->pemodule_inst.act_inst.act_config.inst_regs[30] = to_ac(flex_i.flex_pe3_act_vector_16_31_Inst14);
    dut.pe_ptrs[0]->pemodule_inst.act_inst.act_config.inst_regs[31] = to_ac(flex_i.flex_pe0_act_vector_16_31_Inst15);
    dut.pe_ptrs[1]->pemodule_inst.act_inst.act_config.inst_regs[31] = to_ac(flex_i.flex_pe1_act_vector_16_31_Inst15);
    dut.pe_ptrs[2]->pemodule_inst.act_inst.act_config.inst_regs[31] = to_ac(flex_i.flex_pe2_act_vector_16_31_Inst15);
    dut.pe_ptrs[3]->pemodule_inst.act_inst.act_config.inst_regs[31] = to_ac(flex_i.flex_pe3_act_vector_16_31_Inst15);
    for (auto mem_it = flex_i.flex_pe0_core_input_buffer.begin(); mem_it != flex_i.flex_pe0_core_input_buffer.end(); mem_it++) {
      if (mem_it->first % 16 == 0) {
        spec::VectorType data;
        sc_biguint<32> word_addr = (mem_it->first) >> 4;
        for (int i = 0; i < 16; i++) {
          data[i] = to_ac(flex_i.flex_pe0_core_input_buffer[mem_it->first + i]);
        }
        dut.pe_ptrs[0]->pemodule_inst.pecore_inst.input_mem.SetData(to_ac(word_addr), data);
      }
    }

    for (auto mem_it = flex_i.flex_pe1_core_input_buffer.begin(); mem_it != flex_i.flex_pe1_core_input_buffer.end(); mem_it++) {
      if (mem_it->first % 16 == 0) {
        spec::VectorType data;
        sc_biguint<32> word_addr = (mem_it->first) >> 4;
        for (int i = 0; i < 16; i++) {
          data[i] = to_ac(flex_i.flex_pe1_core_input_buffer[mem_it->first + i]);
        }
        dut.pe_ptrs[1]->pemodule_inst.pecore_inst.input_mem.SetData(to_ac(word_addr), data);
      }
    }

    for (auto mem_it = flex_i.flex_pe2_core_input_buffer.begin(); mem_it != flex_i.flex_pe2_core_input_buffer.end(); mem_it++) {
      if (mem_it->first % 16 == 0) {
        spec::VectorType data;
        sc_biguint<32> word_addr = (mem_it->first) >> 4;
        for (int i = 0; i < 16; i++) {
          data[i] = to_ac(flex_i.flex_pe2_core_input_buffer[mem_it->first + i]);
        }
        dut.pe_ptrs[2]->pemodule_inst.pecore_inst.input_mem.SetData(to_ac(word_addr), data);
      }
    }

    for (auto mem_it = flex_i.flex_pe3_core_input_buffer.begin(); mem_it != flex_i.flex_pe3_core_input_buffer.end(); mem_it++) {
      if (mem_it->first % 16 == 0) {
        spec::VectorType data;
        sc_biguint<32> word_addr = (mem_it->first) >> 4;
        for (int i = 0; i < 16; i++) {
          data[i] = to_ac(flex_i.flex_pe3_core_input_buffer[mem_it->first + i]);
        }
        dut.pe_ptrs[3]->pemodule_inst.pecore_inst.input_mem.SetData(to_ac(word_addr), data);
      }
    }

    for (auto mem_it = flex_i.flex_pe0_core_weight_buffer.begin(); mem_it != flex_i.flex_pe0_core_weight_buffer.end(); mem_it++) {
      if (mem_it->first % 16 == 0) {
        spec::VectorType data;
        sc_biguint<32> word_addr = (mem_it->first) >> 4;
        for (int i = 0; i < 16; i++) {
          data[i] = to_ac(flex_i.flex_pe0_core_weight_buffer[mem_it->first + i]);
        }
        dut.pe_ptrs[0]->pemodule_inst.pecore_inst.weight_mem.SetData(to_ac(word_addr), data);
      }
    }

    for (auto mem_it = flex_i.flex_pe1_core_weight_buffer.begin(); mem_it != flex_i.flex_pe1_core_weight_buffer.end(); mem_it++) {
      if (mem_it->first % 16 == 0) {
        spec::VectorType data;
        sc_biguint<32> word_addr = (mem_it->first) >> 4;
        for (int i = 0; i < 16; i++) {
          data[i] = to_ac(flex_i.flex_pe1_core_weight_buffer[mem_it->first + i]);
        }
        dut.pe_ptrs[1]->pemodule_inst.pecore_inst.weight_mem.SetData(to_ac(word_addr), data);
      }
    }

    for (auto mem_it = flex_i.flex_pe2_core_weight_buffer.begin(); mem_it != flex_i.flex_pe2_core_weight_buffer.end(); mem_it++) {
      if (mem_it->first % 16 == 0) {
        spec::VectorType data;
        sc_biguint<32> word_addr = (mem_it->first) >> 4;
        for (int i = 0; i < 16; i++) {
          data[i] = to_ac(flex_i.flex_pe2_core_weight_buffer[mem_it->first + i]);
        }
        dut.pe_ptrs[2]->pemodule_inst.pecore_inst.weight_mem.SetData(to_ac(word_addr), data);
      }
    }

    for (auto mem_it = flex_i.flex_pe3_core_weight_buffer.begin(); mem_it != flex_i.flex_pe3_core_weight_buffer.end(); mem_it++) {
      if (mem_it->first % 16 == 0) {
        spec::VectorType data;
        sc_biguint<32> word_addr = (mem_it->first) >> 4;
        for (int i = 0; i < 16; i++) {
          data[i] = to_ac(flex_i.flex_pe3_core_weight_buffer[mem_it->first + i]);
        }
        dut.pe_ptrs[3]->pemodule_inst.pecore_inst.weight_mem.SetData(to_ac(word_addr), data);
      }
    }

    for (auto mem_it = flex_i.flex_gb_core_large_buffer.begin(); mem_it != flex_i.flex_gb_core_large_buffer.end(); mem_it++) {
      if (mem_it->first % 16 == 0) {
        spec::VectorType data;
        sc_biguint<32> word_addr = (mem_it->first) >> 4;
        for (int i = 0; i < 16; i++) {
          data[i] = to_ac(flex_i.flex_gb_core_large_buffer[mem_it->first + i]);
        }
        dut.gb_inst.gbmodule_inst.gbcore_inst.large_mem.SetData(to_ac(word_addr), data);
      }
    }
  ...
  void run_ilator() {
    ...
    if (master_done == 1) {
      auto t1 = std::chrono::high_resolution_clock::now();      
      duration_1 =  std::chrono::duration_cast<std::chrono::nanoseconds>(t1 - ref).count();       
      std::cout << "duration: " << (duration_1 - duration) << std::endl;      
    }
...
int sc_main(int argc, char *argv[]) {
  bool tandem_enable = (argc > 1);
  if (!tandem_enable) return 0;
  std::istringstream argv_1(argv[1]);
  int impl_jump_start_instr;  
  float tmp;
  argv_1 >> tmp;
  impl_jump_start_instr = 2170 * tmp;
  nvhls::set_random_seed();
  NVINT8 test = 14;
  cout << fixed2float<8, 3>(test) << endl;  

  testbench tb("tb", impl_jump_start_instr);
