...
void riscv::swap_av(TandemController* v) {
  v->v_top->picorv32_simple->reg_pc = (uint32_t) riscv_pc;
v->v_top->picorv32_simple->cpuregs[0] = (uint32_t) riscv_x0;
v->v_top->picorv32_simple->cpuregs[1] = (uint32_t) riscv_x1;
v->v_top->picorv32_simple->cpuregs[2] = (uint32_t) riscv_x2;
v->v_top->picorv32_simple->cpuregs[3] = (uint32_t) riscv_x3;
v->v_top->picorv32_simple->cpuregs[4] = (uint32_t) riscv_x4;
v->v_top->picorv32_simple->cpuregs[5] = (uint32_t) riscv_x5;
v->v_top->picorv32_simple->cpuregs[6] = (uint32_t) riscv_x6;
v->v_top->picorv32_simple->cpuregs[7] = (uint32_t) riscv_x7;
v->v_top->picorv32_simple->cpuregs[8] = (uint32_t) riscv_x8;
v->v_top->picorv32_simple->cpuregs[9] = (uint32_t) riscv_x9;
v->v_top->picorv32_simple->cpuregs[10] = (uint32_t) riscv_x10;
v->v_top->picorv32_simple->cpuregs[11] = (uint32_t) riscv_x11;
v->v_top->picorv32_simple->cpuregs[12] = (uint32_t) riscv_x12;
v->v_top->picorv32_simple->cpuregs[13] = (uint32_t) riscv_x13;
v->v_top->picorv32_simple->cpuregs[14] = (uint32_t) riscv_x14;
v->v_top->picorv32_simple->cpuregs[15] = (uint32_t) riscv_x15;
v->v_top->picorv32_simple->cpuregs[16] = (uint32_t) riscv_x16;
v->v_top->picorv32_simple->cpuregs[17] = (uint32_t) riscv_x17;
v->v_top->picorv32_simple->cpuregs[18] = (uint32_t) riscv_x18;
v->v_top->picorv32_simple->cpuregs[19] = (uint32_t) riscv_x19;
v->v_top->picorv32_simple->cpuregs[20] = (uint32_t) riscv_x20;
v->v_top->picorv32_simple->cpuregs[21] = (uint32_t) riscv_x21;
v->v_top->picorv32_simple->cpuregs[22] = (uint32_t) riscv_x22;
v->v_top->picorv32_simple->cpuregs[23] = (uint32_t) riscv_x23;
v->v_top->picorv32_simple->cpuregs[24] = (uint32_t) riscv_x24;
v->v_top->picorv32_simple->cpuregs[25] = (uint32_t) riscv_x25;
v->v_top->picorv32_simple->cpuregs[26] = (uint32_t) riscv_x26;
v->v_top->picorv32_simple->cpuregs[27] = (uint32_t) riscv_x27;
v->v_top->picorv32_simple->cpuregs[28] = (uint32_t) riscv_x28;
v->v_top->picorv32_simple->cpuregs[29] = (uint32_t) riscv_x29;
v->v_top->picorv32_simple->cpuregs[30] = (uint32_t) riscv_x30;
v->v_top->picorv32_simple->cpuregs[31] = (uint32_t) riscv_x31;
v->v_top->picorv32_simple->reg_next_pc= riscv_pc + 4;
}
