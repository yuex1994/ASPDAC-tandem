...
void riscv::swap_av(TandemController* v) {
  v->v_top->Rocket->_T_590[31] = (uint32_t) riscv_x0;
v->v_top->Rocket->_T_590[30] = (uint32_t) riscv_x1;
v->v_top->Rocket->_T_590[29] = (uint32_t) riscv_x2;
v->v_top->Rocket->_T_590[28] = (uint32_t) riscv_x3;
v->v_top->Rocket->_T_590[27] = (uint32_t) riscv_x4;
v->v_top->Rocket->_T_590[26] = (uint32_t) riscv_x5;
v->v_top->Rocket->_T_590[25] = (uint32_t) riscv_x6;
v->v_top->Rocket->_T_590[24] = (uint32_t) riscv_x7;
v->v_top->Rocket->_T_590[23] = (uint32_t) riscv_x8;
v->v_top->Rocket->_T_590[22] = (uint32_t) riscv_x9;
v->v_top->Rocket->_T_590[21] = (uint32_t) riscv_x10;
v->v_top->Rocket->_T_590[20] = (uint32_t) riscv_x11;
v->v_top->Rocket->_T_590[19] = (uint32_t) riscv_x12;
v->v_top->Rocket->_T_590[18] = (uint32_t) riscv_x13;
v->v_top->Rocket->_T_590[17] = (uint32_t) riscv_x14;
v->v_top->Rocket->_T_590[16] = (uint32_t) riscv_x15;
v->v_top->Rocket->_T_590[15] = (uint32_t) riscv_x16;
v->v_top->Rocket->_T_590[14] = (uint32_t) riscv_x17;
v->v_top->Rocket->_T_590[13] = (uint32_t) riscv_x18;
v->v_top->Rocket->_T_590[12] = (uint32_t) riscv_x19;
v->v_top->Rocket->_T_590[11] = (uint32_t) riscv_x20;
v->v_top->Rocket->_T_590[10] = (uint32_t) riscv_x21;
v->v_top->Rocket->_T_590[9] = (uint32_t) riscv_x22;
v->v_top->Rocket->_T_590[8] = (uint32_t) riscv_x23;
v->v_top->Rocket->_T_590[7] = (uint32_t) riscv_x24;
v->v_top->Rocket->_T_590[6] = (uint32_t) riscv_x25;
v->v_top->Rocket->_T_590[5] = (uint32_t) riscv_x26;
v->v_top->Rocket->_T_590[4] = (uint32_t) riscv_x27;
v->v_top->Rocket->_T_590[3] = (uint32_t) riscv_x28;
v->v_top->Rocket->_T_590[2] = (uint32_t) riscv_x29;
v->v_top->Rocket->_T_590[1] = (uint32_t) riscv_x30;
v->v_top->Rocket->_T_590[0] = (uint32_t) riscv_x31;
v->v_top->Rocket->mem_reg_pc= riscv_pc;
}
