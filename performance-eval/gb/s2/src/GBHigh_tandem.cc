...
void GBHigh::check_ram_x(RTLVerilated* v) {
  std::cout << "v_ram" << v->v_top->hls_target->hls_target_linebuffer_1_U0->hls_target_linebuffer_U0->hls_target_call_U0->hls_target_call_Loop_LB2D_buf_proc_U0->col_reg_349 << std::endl;
  std::cout << "ram_x" << GBHigh_ram_x << std::endl;
