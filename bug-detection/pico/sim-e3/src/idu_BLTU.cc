...
auto& univ_var_8 = local_var_7;
return univ_var_8;
}
void riscv::update_riscv_BLTU() {
...
auto local_var_224_shifted = riscv_inst >> 31;
auto local_var_224_mask = riscv_inst;
local_var_224_mask = (1 << (31 - 31 + 1)) - 1;
local_var_224_mask &= local_var_224_shifted;
uint1_t local_var_224 = boost::numeric_cast<uint1_t>(local_var_224_mask);
auto local_var_225_shifted = riscv_inst >> 7;
auto local_var_225_mask = riscv_inst;
local_var_225_mask = (1 << (7 - 7 + 1)) - 1;
local_var_225_mask &= local_var_225_shifted;
uint1_t local_var_225 = boost::numeric_cast<uint1_t>(local_var_225_mask);
auto local_var_226_shifted = riscv_inst >> 25;
auto local_var_226_mask = riscv_inst;
local_var_226_mask = (1 << (30 - 25 + 1)) - 1;
local_var_226_mask &= local_var_226_shifted;
uint6_t local_var_226 = boost::numeric_cast<uint6_t>(local_var_226_mask);
auto local_var_227_shifted = riscv_inst >> 8;
auto local_var_227_mask = riscv_inst;
local_var_227_mask = (1 << (11 - 8 + 1)) - 1;
local_var_227_mask &= local_var_227_shifted;
uint4_t local_var_227 = boost::numeric_cast<uint4_t>(local_var_227_mask);
uint1_t local_var_228 = 0;
univ_var_2 = (boost::numeric_cast<uint5_t>(local_var_227) << 1) + boost::numeric_cast<uint5_t>(local_var_228);
univ_var_3 = (boost::numeric_cast<uint11_t>(local_var_226) << 5) + boost::numeric_cast<uint11_t>(univ_var_2);
univ_var_4 = (boost::numeric_cast<uint12_t>(local_var_225) << 11) + boost::numeric_cast<uint12_t>(univ_var_3);
univ_var_5 = (boost::numeric_cast<uint13_t>(local_var_224) << 12) + boost::numeric_cast<uint13_t>(univ_var_4);
uint32_t local_var_233 = boost::numeric_cast<uint32_t>(((univ_var_5 >> 12) == 1) ? (~univ_var_5) : univ_var_5);
local_var_233 = ((univ_var_5 >> 12) == 1) ? (~local_var_233) : local_var_233;
uint32_t local_var_234 = (riscv_pc + local_var_233);
uint32_t local_var_235 = 4;
uint32_t local_var_236 = (riscv_pc + local_var_235);
auto local_var_237 = (local_var_222) ? local_var_234 : local_var_236;
auto local_var_237_nxt_holder = local_var_237;
riscv_pc = local_var_237_nxt_holder;
#ifdef ILATOR_VERBOSE
instr_update_log << "No." << std::dec << GetInstrCntr() << '\t' << "BLTU state updates:" << std::endl;
