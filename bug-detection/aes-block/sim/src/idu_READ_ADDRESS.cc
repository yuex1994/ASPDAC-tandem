...
auto& univ_var_25 = local_var_11;
return univ_var_25;
}
void AES::update_AES_READ_ADDRESS() {
...
auto local_var_9_shifted = AES_aes_address >> 0;
auto local_var_9_mask = AES_aes_address;
...
instr_update_log << "No." << std::dec << GetInstrCntr() << '\t' << "READ_ADDRESS state updates:" << std::endl;
