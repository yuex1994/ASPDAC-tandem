...
auto& univ_var_6 = local_var_7;
return univ_var_6;
}
void riscv::update_riscv_BNE() {
...
bool local_var_223 = !local_var_222;
auto local_var_225_shifted = riscv_inst >> 31;
auto local_var_225_mask = riscv_inst;
local_var_225_mask = (1 << (31 - 31 + 1)) - 1;
local_var_225_mask &= local_var_225_shifted;
uint1_t local_var_225 = boost::numeric_cast<uint1_t>(local_var_225_mask);
auto local_var_226_shifted = riscv_inst >> 7;
auto local_var_226_mask = riscv_inst;
local_var_226_mask = (1 << (7 - 7 + 1)) - 1;
local_var_226_mask &= local_var_226_shifted;
uint1_t local_var_226 = boost::numeric_cast<uint1_t>(local_var_226_mask);
auto local_var_227_shifted = riscv_inst >> 25;
auto local_var_227_mask = riscv_inst;
local_var_227_mask = (1 << (30 - 25 + 1)) - 1;
local_var_227_mask &= local_var_227_shifted;
uint6_t local_var_227 = boost::numeric_cast<uint6_t>(local_var_227_mask);
auto local_var_228_shifted = riscv_inst >> 8;
auto local_var_228_mask = riscv_inst;
local_var_228_mask = (1 << (11 - 8 + 1)) - 1;
local_var_228_mask &= local_var_228_shifted;
uint4_t local_var_228 = boost::numeric_cast<uint4_t>(local_var_228_mask);
uint1_t local_var_229 = 0;
univ_var_2 = (boost::numeric_cast<uint5_t>(local_var_228) << 1) + boost::numeric_cast<uint5_t>(local_var_229);
univ_var_3 = (boost::numeric_cast<uint11_t>(local_var_227) << 5) + boost::numeric_cast<uint11_t>(univ_var_2);
univ_var_4 = (boost::numeric_cast<uint12_t>(local_var_226) << 11) + boost::numeric_cast<uint12_t>(univ_var_3);
univ_var_5 = (boost::numeric_cast<uint13_t>(local_var_225) << 12) + boost::numeric_cast<uint13_t>(univ_var_4);
uint32_t local_var_234 = boost::numeric_cast<uint32_t>(((univ_var_5 >> 12) == 1) ? (~univ_var_5) : univ_var_5);
local_var_234 = ((univ_var_5 >> 12) == 1) ? (~local_var_234) : local_var_234;
uint32_t local_var_235 = (riscv_pc + local_var_234);
uint32_t local_var_236 = 4;
uint32_t local_var_237 = (riscv_pc + local_var_236);
auto local_var_238 = (local_var_223) ? local_var_235 : local_var_237;
auto local_var_238_nxt_holder = local_var_238;
riscv_pc = local_var_238_nxt_holder;
#ifdef ILATOR_VERBOSE
instr_update_log << "No." << std::dec << GetInstrCntr() << '\t' << "BNE state updates:" << std::endl;
